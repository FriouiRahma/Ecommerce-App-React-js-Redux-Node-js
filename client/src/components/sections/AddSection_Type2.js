...
import { addsection2 } from "../../actions/sectiontype2";
import AdminLayout from "../layout/AdminLayout";
import screen from "../../images/screens/02.png";

const AddSection = ({ addsection2, history }) => {
  ...
  const { name, titre, video } = formData;
  const onChange = (e) =>
    setFormData({
      ...formData,
  ...
  const onSubmit = async (e) => {
    ...
    addsection2({ name, titre, productID, video, history });
  };
      ...
      <AdminLayout>
        <div className="add-section2-admin">
          ...
          <form onSubmit={(e) => onSubmit(e)}>
            ...
            <div className="form-group">
              <label htmlFor="">Ajouter video</label>
...
export default connect(mapStateToProps, { addsection2 })(AddSection);
