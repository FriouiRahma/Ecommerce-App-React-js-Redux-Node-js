...
const BoutiqueDetail = ({ boutiquesList }) => {
    useEffect(() => {
 ...
 const boutiquesdetail=boutiquesList &&boutiquesList.length!==0&& boutiquesList.filter(el=>el.type ==="0")
       console.log('boutiquesgros',boutiquesdetail)
        ...
        return (
            ...
            <div className='row'>
                {boutiquesdetail&&boutiquesdetail.length!==0&&boutiquesdetail.map((bout) => (
...
export default connect(mapStateToProps, { loadBoutiques })(BoutiqueDetail);
